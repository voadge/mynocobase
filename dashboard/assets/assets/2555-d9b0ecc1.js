"use strict";(globalThis.webpackChunknocobase=globalThis.webpackChunknocobase||[]).push([["2555"],{53494(e,t,r){r.r(t),r.d(t,{default:()=>c});let c={contexts:[r(79271).JSBlockRunJSContext],prefix:"sn-jsb-info-card",label:"Render record info card",description:"Display current record information in an Ant Design card",locales:{"zh-CN":{label:"渲染记录信息卡片",description:"使用 Ant Design 卡片显示当前记录的关键信息"}},content:`
