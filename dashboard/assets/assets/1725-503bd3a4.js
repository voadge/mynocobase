"use strict";(globalThis.webpackChunknocobase=globalThis.webpackChunknocobase||[]).push([["1725"],{40812(e,o,t){t.r(o),t.d(o,{default:()=>n});let n={contexts:[t(79271).JSBlockRunJSContext],prefix:"sn-jsb-vue",label:"Embed Vue component",description:"Use ctx.importAsync to load Vue 3 ESM build and render a reactive widget",locales:{"zh-CN":{label:"嵌入 Vue 组件",description:"通过 ctx.importAsync 加载 Vue 3 ESM 构建并渲染交互组件"}},content:`
