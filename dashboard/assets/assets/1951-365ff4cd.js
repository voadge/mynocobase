"use strict";(globalThis.webpackChunknocobase=globalThis.webpackChunknocobase||[]).push([["1951"],{47890(t,e,s){s.r(e),s.d(e,{default:()=>a});let a={contexts:[s(79271).JSBlockRunJSContext],prefix:"sn-jsb-stats",label:"Render statistics cards",description:"Display multiple statistic cards with numbers from API",locales:{"zh-CN":{label:"渲染统计卡片",description:"显示多个统计数字卡片（从 API 获取数据）"}},content:`
