"use strict";(globalThis.webpackChunknocobase=globalThis.webpackChunknocobase||[]).push([["1310"],{39101(a,e,r){r.r(e),r.d(e,{default:()=>t});let t={contexts:[r(79271).JSBlockRunJSContext],prefix:"sn-jsb-chartjs",label:"Render Chart.js bar chart",description:"Load Chart.js from CDN and render a basic bar chart inside the block",locales:{"zh-CN":{label:"渲染 Chart.js 柱状图",description:"通过 CDN 引入 Chart.js 并在区块中渲染基础柱状图"}},content:`
