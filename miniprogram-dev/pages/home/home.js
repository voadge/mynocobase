...
var workSections = [
  { letter: 'A', title: '科技研发', accent: '#993556', items: [
  ...
  { letter: 'B', title: '项目实施', accent: '#185FA5', items: [
  ...
  { letter: 'C', title: '物资采购', accent: '#0f6e56', items: [
  ...
  { letter: 'D', title: '常用流程', accent: '#854F0B', items: [
    { label: '小修台账', url: '/admin/32y3lm7skny' }
  ]},
  { letter: 'E', title: '财务行政', accent: '#b86e20', items: [
  ...
  { letter: 'F', title: '基础数据', accent: '#4a4e69', items: [
