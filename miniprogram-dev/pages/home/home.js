...
const workSections = [
  { title: 'A 科技研发', bg: '#2a0f1c', border: '#993556', color: '#e890b0', btnBg: '#3d1828', btnBorder: '#993556', btnColor: '#f4c0d1', items: [
  ...
  { title: 'B 项目实施', bg: '#0f1f3d', border: '#185FA5', color: '#8cc4ff', btnBg: '#1a3055', btnBorder: '#185FA5', btnColor: '#b5d4f4', items: [
  ...
  { title: 'C 物资采购', bg: '#0f2a20', border: '#0f6e56', color: '#5cccb0', btnBg: '#1a3d30', btnBorder: '#0f6e56', btnColor: '#9fe1cb', items: [
  ...
  { title: 'D 常用流程', bg: '#2a1f0b', border: '#854F0B', color: '#f0b84d', btnBg: '#3d2e14', btnBorder: '#854F0B', btnColor: '#fac775', items: [
    { label: '首页', url: '/admin/ffw9h2yb5cp' }
  ]},
  { title: 'E 财务行政', bg: '#2a180b', border: '#b86e20', color: '#f5c87a', btnBg: '#3d2614', btnBorder: '#b86e20', btnColor: '#fadb9a', items: [
  ...
  { title: 'F 基础数据', bg: '#1a1a2e', border: '#4a4e69', color: '#b0b5d4', btnBg: '#282840', btnBorder: '#4a4e69', btnColor: '#ced2e8', items: [
