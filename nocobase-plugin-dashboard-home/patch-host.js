const fs = require('fs');
const HOST_FILE = '/opt/noco-base/nocobase-plugin-dashboard-home/dist/server/middleware/dashboard.js';
let content = fs.readFileSync(HOST_FILE, 'utf8');
let changes = 0;
...
if (changes > 0) {
  fs.writeFileSync(HOST_FILE, content);
  console.log('Applied ' + changes + ' changes to host file');
} else {
