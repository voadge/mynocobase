...
function registerPageRoutes(app) {
  app.use(async (ctx, next) => {
    ...
    const __public = ["/__tb__", "/__fp__", "/__tp__"].indexOf(ctx.state.reqPath) >= 0; if (__public || await (0, auth_1.isAuthenticated)(ctx)) {
      ...
      try {
        ...
        const html = fs_1.readFileSync(htmlPath, 'utf-8');
