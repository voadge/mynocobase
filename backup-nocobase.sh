...
# Saves a compressed SQL dump to /opt/noco-base/backups/
# Runs via cron - designed for daily execution
...
# Create the backup using pg_dump inside the PostgreSQL container
