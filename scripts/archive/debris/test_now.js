...
var opts = {hostname:'127.0.0.1',port:13000,path:'/api/__pd__/attendance/submit',method:'POST',headers:{'Content-Type':'application/json','Content-Length':Buffer.byteLength(d)}};
