...
ssh -o StrictHostKeyChecking=no -i "C:\Users\tsong\.ssh\voadge.pem" ubuntu@110.42.236.231 'sudo docker exec noco-base-app-1 /opt/noco-base/storage/scripts/10-dashboard.sh'
